...
+ (void) initialize
{
    if (self == [DACircularProgressView class]) {
        ...
        [circularProgressViewAppearance setTrackTintColor:[UIColor clearColor]];
        [circularProgressViewAppearance setProgressTintColor:[UIColor colorWithRed:0.305 green:0.792 blue:0.960 alpha:1]];
