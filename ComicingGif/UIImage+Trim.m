 ...
 */
- (UIEdgeInsets)transparencyInsetsRequiringFullOpacity:(BOOL)fullyOpaque trimTop:(BOOL)isTrimTop
{
...
{
	return [self imageByTrimmingTransparentPixelsRequiringFullOpacity:YES];
}
...
{
   return [self imageByTrimmingTransparentPixelsRequiringFullOpacity:fullyOpaque trimTop:NO];
}

- (UIImage *)imageByTrimmingTransparentPixelsRequiringFullOpacity:(BOOL)fullyOpaque trimTop:(BOOL)isTrimTop
{
    ...
    UIEdgeInsets crop = [self transparencyInsetsRequiringFullOpacity:fullyOpaque trimTop:isTrimTop];
